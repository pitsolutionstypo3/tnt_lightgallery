...
$GLOBALS['TCA']['tx_tntlightgallery_domain_model_lightgallery'] = array(
    ...
    'types' => array(
        '1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource,gallerytitle,collections;;1, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
    ),
    'palettes' => array(
        '1' => array('showitem' => ''),
    ),
    'columns' => array(
        ...
        'collections' => Array(
            ...
            "config" => Array(
                "type" => "inline",
                "foreign_table" => "tx_tntlightgallery_domain_model_lightgallery_collections",
                "maxitems" => 100,
                'appearance' => array(
